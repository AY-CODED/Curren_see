...
final alertsProvider =
    StreamProvider.family<List<RateAlert>, String>((ref, uid) {
...
class _AlertCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final current = rates.isNotEmpty
        ? rateService.getRate(
            alert.baseCurrency, alert.targetCurrency, rates)
        : 0.0;
    final distance =
        current > 0 ? ((alert.targetRate - current) / current * 100) : 0.0;
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: CurrencyIcon(
                              code: alert.targetCurrency, size: 28),
                        ),
                      ),
                    ],
                  ),
                      ...
                      RichText(
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                                text:
                                    'When rate goes ${alert.condition} '),
                            TextSpan(
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      letterSpacing: 0.66,
                      color:
                          alert.isActive ? AppColors.gold : AppColors.ink2,
                    ),
                  ),
                ),
              ],
